...
<h2 align="center">Apoyando a MarkNotePro</h2>

MarkNotePro es un editor de Markdown de código abierto impulsado por el apoyo de su comunidad. Si MarkNotePro mejora tu flujo de trabajo, considera [patrocinar el proyecto](https://github.com/scott20201225). Gracias a todos los patrocinadores ❤️

**Patrocinador Especial**

| [<img src="../assets/sponsors/serpapi.png" width="150">](https://serpapi.com/?utm_source=marknotepro) | [Extrae resultados de Google y otros motores de búsqueda con nuestra API rápida, sencilla y completa.](https://serpapi.com/?utm_source=marknotepro) |
| ------------- |:-------------|
...
Puedes descargar el último `marknotepro-%version%.dmg` desde la [página de releases](https://github.com/scott20201225/marknote-pro/releases/latest) o instalar MarkNotePro usando [**homebrew cask**](https://github.com/caskroom/homebrew-cask). Para usar Homebrew-Cask solo necesitas tener [Homebrew](https://brew.sh/) instalado.
...
Simplemente descarga e instala MarkNotePro mediante el asistente de configuración (`marknotepro-setup-%version%.exe`) y elige si instalarlo por usuario o para todo el sistema. Alternativamente, instala MarkNotePro usando un gestor de paquetes como [Chocolatey](https://chocolatey.org/) o [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/).
...
Todos los binarios para Linux, macOS y Windows se pueden descargar desde la [página de releases](https://github.com/scott20201225/marknote-pro/releases/latest). Si no hay una versión disponible para tu sistema, por favor abre un [issue](https://github.com/scott20201225/marknote-pro/issues).

## Desarrollo

Si deseas compilar MarkNotePro tú mismo, consulta nuestras [instrucciones de compilación](../dev/BUILD.md).

- [Documentación de usuario](../README.md)
- [Documentación de desarrollador](../dev/README.md)

Si tienes preguntas sobre MarkNotePro, puedes abrir un issue. Por favor usa el formato predeterminado al hacerlo. Por supuesto, si envías un PR directamente, será muy apreciado.

## Contribución

MarkNotePro está en desarrollo. Por favor lee la [Guía de Contribución](../../.github/CONTRIBUTING.md) antes de hacer un pull request. ¿Quieres añadir funciones a MarkNotePro? Consulta nuestra [hoja de ruta](https://github.com/scott20201225/marknote-pro/projects) e issues abiertos.


## Colaboradores

Gracias a todas las personas que ya han contribuido a MarkNotePro[[colaboradores](https://github.com/scott20201225/marknote-pro/graphs/contributors)].
