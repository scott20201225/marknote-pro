...
<h2 align="center">MarkNotePro'e Destek Olun</h2>

MarkNotePro, topluluğunun desteğiyle hayata geçirilmiş açık kaynaklı bir Markdown editörüdür. MarkNotePro iş akışınızı iyileştiriyorsa, lütfen [projeye destek olmayı](https://github.com/scott20201225) düşünün. Tüm destekçilere teşekkürler ❤️

**Özel Destekçi**

| [<img src="../assets/sponsors/serpapi.png" width="150">](https://serpapi.com/?utm_source=marknotepro) | [Hızlı, kolay ve kapsamlı API'miz ile Google ve diğer arama motorlarından veri çekin.](https://serpapi.com/?utm_source=marknotepro) |
| ------------- |:-------------|
...
[Sürümler sayfasından](https://github.com/scott20201225/marknote-pro/releases/latest) en son `marknotepro-%version%.dmg`'yi indirebilir veya [**homebrew cask**](https://github.com/caskroom/homebrew-cask) kullanarak MarkNotePro'i kurabilirsiniz. Homebrew-Cask kullanmak için [Homebrew](https://brew.sh/)'ün yüklü olması gerekir.
...
MarkNotePro'i kurulum sihirbazı (`marknotepro-setup-%version%.exe`) aracılığıyla indirip kurun ve kullanıcı başına mı yoksa sistem genelinde mi kurulacağını seçin. Alternatif olarak [Chocolatey](https://chocolatey.org/) veya [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/) gibi bir paket yöneticisi kullanabilirsiniz.
...
Linux, macOS ve Windows için tüm ikili dosyalar [sürümler sayfasından](https://github.com/scott20201225/marknote-pro/releases/latest) indirilebilir. Sisteminiz için bir sürüm mevcut değilse lütfen bir [issue](https://github.com/scott20201225/marknote-pro/issues) açın.

## Geliştirme

MarkNotePro'i kendiniz derlemek istiyorsanız lütfen [derleme talimatlarımıza](../dev/BUILD.md) bakın.

- [Kullanıcı belgeleri](../README.md)
- [Geliştirici belgeleri](../dev/README.md)

MarkNotePro hakkında sorularınız varsa bir issue yazabilirsiniz. Bunu yaparken issue açarken görünen varsayılan formatı kullanın. Elbette doğrudan bir PR gönderirseniz çok memnun oluruz.

## Katkı

MarkNotePro geliştirme aşamasındadır. Bir pull request oluşturmadan önce [Katkı Kılavuzunu](../../.github/CONTRIBUTING.md) okuduğunuzdan emin olun. MarkNotePro'e özellik eklemek ister misiniz? [Yol haritamıza](https://github.com/scott20201225/marknote-pro/projects) ve açık issue'lara bakın.


## Katkıda Bulunanlar

MarkNotePro'e zaten katkıda bulunan herkese teşekkür ederiz[[katkıda bulunanlar](https://github.com/scott20201225/marknote-pro/graphs/contributors)].
