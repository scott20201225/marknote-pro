...
<h2 align="center">MarkNotePro unterstützen</h2>

MarkNotePro ist ein Open-Source-Markdown-Editor, der von seiner Community unterstützt wird. Wenn MarkNotePro Ihren Workflow verbessert, erwägen Sie bitte, [das Projekt zu sponsern](https://github.com/scott20201225). Vielen Dank an alle Sponsoren ❤️

**Besonderer Sponsor**

| [<img src="../assets/sponsors/serpapi.png" width="150">](https://serpapi.com/?utm_source=marknotepro) | [Extrahieren Sie Daten von Google und anderen Suchmaschinen über unsere schnelle, einfache und vollständige API.](https://serpapi.com/?utm_source=marknotepro) |
| ------------- |:-------------|
...
Du kannst entweder die neueste `marknotepro-%version%.dmg` von der [Release-Seite](https://github.com/scott20201225/marknote-pro/releases/latest) herunterladen oder MarkNotePro über [**homebrew cask**](https://github.com/caskroom/homebrew-cask) installieren. Für Homebrew-Cask muss [Homebrew](https://brew.sh/) installiert sein.
...
Lade MarkNotePro einfach über den Setup-Assistenten (`marknotepro-setup-%version%.exe`) herunter und installiere es, wähle dabei zwischen Benutzer- oder systemweiter Installation. Alternativ kann MarkNotePro über einen Paketmanager wie [Chocolatey](https://chocolatey.org/) oder [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/) installiert werden.
...
Alle Binärdateien für Linux, macOS und Windows können von der [Release-Seite](https://github.com/scott20201225/marknote-pro/releases/latest) heruntergeladen werden. Falls keine Version für dein System verfügbar ist, öffne bitte ein [Issue](https://github.com/scott20201225/marknote-pro/issues).

## Entwicklung

Wenn du MarkNotePro selbst erstellen möchtest, sieh dir bitte unsere [Build-Anleitung](../dev/BUILD.md) an.

- [Benutzerdokumentation](../README.md)
- [Entwicklerdokumentation](../dev/README.md)

Bei Fragen zu MarkNotePro kannst du gerne ein Issue erstellen. Bitte verwende dabei das Standardformat. Natürlich ist auch ein direkter PR sehr willkommen.

## Beitrag

MarkNotePro befindet sich in der Entwicklung. Bitte lies den [Beitragsleitfaden](../../.github/CONTRIBUTING.md) vor dem Erstellen eines Pull Requests. Möchtest du Funktionen zu MarkNotePro hinzufügen? Sieh dir unsere [Roadmap](https://github.com/scott20201225/marknote-pro/projects) und offene Issues an.


## Mitwirkende

Danke an alle, die bereits zu MarkNotePro beigetragen haben[[Mitwirkende](https://github.com/scott20201225/marknote-pro/graphs/contributors)].
