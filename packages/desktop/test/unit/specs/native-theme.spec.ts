...
describe('Native theme source', () => {
  ...
  it('uses dark native menus for dark MarkNotePro themes', () => {
  ...
  it('uses the shared MarkNotePro dark theme classification', () => {
  ...
  it('uses light native menus for light MarkNotePro themes', () => {
